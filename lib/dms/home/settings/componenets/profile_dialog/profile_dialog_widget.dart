...
export 'profile_dialog_model.dart';
...
class _ProfileDialogWidgetState extends State<ProfileDialogWidget>
  ...
  late ProfileDialogModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProfileDialogModel());
                        ...
                        children: [
                          ...
                          Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                0.0, 4.0, 0.0, 0.0),
                            child: Text(
                              FFAppState().role == 1 ? 'General' : 'Admin',
                              style: FlutterFlowTheme.of(context)
                                  .bodySmall
                                  .override(
                                    font: GoogleFonts.plusJakartaSans(),
                  ...
                  child: Column(
                    ...
                    children: [
                      InkWell(
                        ...
                        onTap: () async {
                          logFirebaseEvent(
                              'PROFILE_DIALOG_COMP_wrapWidget_ON_TAP');
                          if (_model.accountSwitcher) {
                            _model.accountSwitcher = false;
                            safeSetState(() {});
                          } else {
                            _model.accountSwitcher = true;
                            safeSetState(() {});
                          }
                        },
                          ...
                          child: Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                if (_model.accountSwitcher == true)
                                  Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                        0.0, 0.0, 15.0, 0.0),
                                    child: Icon(
                                ...
                                if (_model.accountSwitcher == false)
                                  Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                        0.0, 0.0, 15.0, 0.0),
                                    child: Icon(
              ...
              Padding(
                ...
                child: MouseRegion(
                  ...
                  child: InkWell(
                    ...
                    onTap: () async {
                      logFirebaseEvent(
                          'PROFILE_DIALOG_convertComponent_ON_TAP');
                        ...
                        children: [
                          Expanded(
                            child: InkWell(
                              ...
                              onTap: () async {
                                logFirebaseEvent(
                                    'PROFILE_DIALOG_Container_jkk2nnsx_ON_TAP');
                          ...
                          Expanded(
                            child: InkWell(
                              ...
                              onTap: () async {
                                logFirebaseEvent(
                                    'PROFILE_DIALOG_Container_t4b5m6tr_ON_TAP');
              ...
              Align(
                ...
                child: Padding(
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      logFirebaseEvent(
                          'PROFILE_DIALOG_COMP_LOG_OUT_BTN_ON_TAP');
