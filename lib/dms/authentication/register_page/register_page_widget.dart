...
class _RegisterPageWidgetState extends State<RegisterPageWidget> {
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<DepartmentsRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<DepartmentsRow> registerPageDepartmentsRowList = snapshot.data!;
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        ...
                                        child: FlutterFlowIconButton(
                                          ...
                                          onPressed: () async {
                                            logFirebaseEvent(
                                                'REGISTER_PAGE_PAGE_camera_alt_ICN_ON_TAP');
                                            final selectedMedia =
                                  ...
                                  children: [
                                    Align(
                                      ...
                                      child: FlutterFlowDropDown<String>(
                                        ...
                                        options: registerPageDepartmentsRowList
                                            .map((e) => e.nameEng)
                                            .withoutNulls
                                            .toList(),
                                        onChanged: (val) => safeSetState(
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      ...
                                      await UsersTable().insert({
                                        ...
                                        'gender': _model.generDropDownValue,
                                        'address':
                                        ...
                                        'password':
                                            _model.passwordTextController.text,
                                        'departments': _model.dropDownValue,
                                      });
                                    },
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            FFButtonWidget(
                              onPressed: () async {
                                logFirebaseEvent(
                                    'REGISTER_PAGE_PAGE_LOG_IN_BTN_ON_TAP');
