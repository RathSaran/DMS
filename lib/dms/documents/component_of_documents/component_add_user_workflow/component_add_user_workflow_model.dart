...
import 'dart:ui';
import 'component_add_user_workflow_widget.dart'
    show ComponentAddUserWorkflowWidget;
...
class ComponentAddUserWorkflowModel
    extends FlutterFlowModel<ComponentAddUserWorkflowWidget> {
  ...
  // Stores action output result for [Backend Call - Query Rows] action in ComponentAddUserWorkflow widget.
  List<DepartmentsRow>? allDepartments;
