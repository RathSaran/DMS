...
import 'component_edit_user_workflow_model.dart';
export 'component_edit_user_workflow_model.dart';

class ComponentEditUserWorkflowWidget extends StatefulWidget {
  const ComponentEditUserWorkflowWidget({
    super.key,
    this.edit,
  });
  ...
  @override
  State<ComponentEditUserWorkflowWidget> createState() =>
      _ComponentEditUserWorkflowWidgetState();
}

class _ComponentEditUserWorkflowWidgetState
    extends State<ComponentEditUserWorkflowWidget> {
  late ComponentEditUserWorkflowModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ComponentEditUserWorkflowModel());
            ...
            children: [
              ...
              Column(
                ...
                children: [
                          ...
                          child: Padding(
                            ...
                            child: Wrap(
                              ...
                              children: [
                                Builder(
                                  builder: (context) {
                                    final serverities = getJsonField(
                                      widget!.edit,
                                      r'''$.serverity''',
                                    ).toList();
                                              ...
                                              child: Row(
                                                ...
                                                children: [
                                                  ...
                                                  InkWell(
                                                    ...
                                                    onTap: () async {
                                                      logFirebaseEvent(
                                                          'COMPONENT_EDIT_USER_WORKFLOW_Icon_1g7zul');
                                                      FFAppState()
                                ...
                                Container(
                                  ...
                                  child: FlutterFlowDropDown<String>(
                                    ...
                                    onChanged: (val) async {
                                      ...
                                      logFirebaseEvent(
                                          'COMPONENT_EDIT_USER_WORKFLOW_DropDown_gc');
                        ...
                        Theme(
                          ...
                          child: Checkbox(
                            ...
                            onChanged: (newValue) async {
                              ...
                              if (newValue!) {
                                logFirebaseEvent(
                                    'COMPONENT_EDIT_USER_WORKFLOW_Checkbox_s6');
                  ...
                  if (_model.dropDownValue2 != 'All Departments')
                    Padding(
                      padding:
                          EdgeInsetsDirectional.fromSTEB(0.0, 10.0, 0.0, 0.0),
                      child: Container(
                                            ...
                                            Theme(
                                              ...
                                              child: Checkbox(
                                                ...
                                                onChanged: (newValue) async {
                                                  ...
                                                  if (newValue!) {
                                                    logFirebaseEvent(
                                                        'COMPONENT_EDIT_USER_WORKFLOW_Checkbox_95');
                                                    FFAppState()
                                                        .addToDepartmentId(
                                                            listViewDepartmentsRow
                                                                .id
                                                            ...
                                                            Theme(
                                                              ...
                                                              child: Checkbox(
                                                                ...
                                                                onChanged:
                                                                  ...
                                                                  if (newValue!) {
                                                                    logFirebaseEvent(
                                                                        'COMPONENT_EDIT_USER_WORKFLOW_selectUser_');
                                                                    FFAppState()
                                                                        .addToUserIds(
                                                                            columnUsersRow.id);
                                                                    safeSetState(
                                                            ...
                                                            Theme(
                                                              ...
                                                              child: Checkbox(
                                                                ...
                                                                onChanged:
                                                                  ...
                                                                  if (newValue!) {
                                                                    logFirebaseEvent(
                                                                        'COMPONENT_EDIT_USER_WORKFLOW_Checkbox_iy');
                                                                            ...
                                                                            Theme(
                                                                              ...
                                                                              child: Checkbox(
                                                                                ...
                                                                                onChanged: (newValue) async {
                                                                                  ...
                                                                                  if (newValue!) {
                                                                                    logFirebaseEvent('COMPONENT_EDIT_USER_WORKFLOW_selectUser_');
                                                                            ...
                                                                            Theme(
                                                                              ...
                                                                              child: Checkbox(
                                                                                ...
                                                                                onChanged: (newValue) async {
                                                                                  ...
                                                                                  if (newValue!) {
                                                                                    logFirebaseEvent('COMPONENT_EDIT_USER_WORKFLOW_Checkbox_3w');
                                                                                            ...
                                                                                            Theme(
                                                                                              ...
                                                                                              child: Checkbox(
                                                                                                ...
                                                                                                onChanged: (newValue) async {
                                                                                                  ...
                                                                                                  if (newValue!) {
                                                                                                    logFirebaseEvent('COMPONENT_EDIT_USER_WORKFLOW_Checkbox_m2');
                                                                                                    FFAppState().addToDepartmentId(listUserDepartmentsRow!.id.toString());
                                                                                                    safeSetState(() {});
                                                                                                  } else {
                                                                                                    logFirebaseEvent('COMPONENT_EDIT_USER_WORKFLOW_Checkbox_m2');
                                                ...
                                                Theme(
                                                  ...
                                                  child: Checkbox(
                                                    ...
                                                    onChanged:
                                                      ...
                                                      if (newValue!) {
                                                        logFirebaseEvent(
                                                            'COMPONENT_EDIT_USER_WORKFLOW_Checkbox_ts');
                                                        FFAppState()
                                                            .addToDepartmentId(
                                                                listViewDepartmentsRow
                                                                    .id
                                                                ...
                                                                Theme(
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    onChanged:
                                                                      ...
                                                                      if (newValue!) {
                                                                        logFirebaseEvent(
                                                                            'COMPONENT_EDIT_USER_WORKFLOW_Checkbox_yh');
                                                                                ...
                                                                                Theme(
                                                                                  ...
                                                                                  child: Checkbox(
                                                                                    ...
                                                                                    onChanged: (newValue) async {
                                                                                      ...
                                                                                      if (newValue!) {
                                                                                        logFirebaseEvent('COMPONENT_EDIT_USER_WORKFLOW_Checkbox_8x');
                                                                                        FFAppState().addToDepartmentId(listUserDepartmentsRow!.id.toString());
                                                                                        safeSetState(() {});
                                                                                      } else {
                                                                                        logFirebaseEvent('COMPONENT_EDIT_USER_WORKFLOW_Checkbox_8x');
                                                                                                ...
                                                                                                Theme(
                                                                                                  ...
                                                                                                  child: Checkbox(
                                                                                                    ...
                                                                                                    onChanged: (newValue) async {
                                                                                                      ...
                                                                                                      if (newValue!) {
                                                                                                        logFirebaseEvent('COMPONENT_EDIT_USER_WORKFLOW_Checkbox_ki');
                                                                                                        FFAppState().addToDepartmentId(listUserDepartmentsRow!.id.toString());
                                                                                                        safeSetState(() {});
                                                                                                      } else {
                                                                                                        logFirebaseEvent('COMPONENT_EDIT_USER_WORKFLOW_Checkbox_ki');
                ...
                child: Row(
                  ...
                  children: [
                    FFButtonWidget(
                      onPressed: () async {
                        logFirebaseEvent(
                            'COMPONENT_EDIT_USER_WORKFLOW_CANCEL_BTN_');
                    ...
                    FFButtonWidget(
                      onPressed: () async {
                        logFirebaseEvent(
                            'COMPONENT_EDIT_USER_WORKFLOW_SAVE_BTN_ON');
                        Navigator.pop(context);
                        FFAppState().updateUserOrganizationsAtIndex(
                          widget!.edit!,
