...
import 'component_attachment_model.dart';
export 'component_attachment_model.dart';

class ComponentAttachmentWidget extends StatefulWidget {
  const ComponentAttachmentWidget({super.key});

  @override
  State<ComponentAttachmentWidget> createState() =>
      _ComponentAttachmentWidgetState();
}

class _ComponentAttachmentWidgetState extends State<ComponentAttachmentWidget> {
  late ComponentAttachmentModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ComponentAttachmentModel());
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) => safeSetState(() {
          _model.tfFieldNameTextController?.text =
            ...
            'rxqdjm3v' /* Please in put full name... */,
          );
        ...
        children: [
          Container(
            ...
            child: InkWell(
              ...
              onTap: () async {
                logFirebaseEvent('COMPONENT_ATTACHMENT_bg_color_ON_TAP');
                            ...
                            FlutterFlowDropDown<String>(
                              controller: _model.dropDownValueController ??=
                                ...
                                _model.dropDownValue ??=
                                    FFLocalizations.of(context).getText(
                                  'akv6atey' /* sovathvong@gmail.com */,
                                ),
                              ),
                              options: [
                                FFLocalizations.of(context).getText(
                                  'tu9euym5' /* sovathvong@gmail.com */,
                                ),
                                FFLocalizations.of(context).getText(
                                  '9nqur5b6' /* sovathvong@oone.bz */,
                                )
                              ],
