...
import 'component_phone_model.dart';
export 'component_phone_model.dart';

class ComponentPhoneWidget extends StatefulWidget {
  const ComponentPhoneWidget({super.key});

  @override
  State<ComponentPhoneWidget> createState() => _ComponentPhoneWidgetState();
}

class _ComponentPhoneWidgetState extends State<ComponentPhoneWidget> {
  late ComponentPhoneModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ComponentPhoneModel());
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) => safeSetState(() {
          _model.tfFieldNameTextController?.text =
            ...
            'o6jxhfys' /* Please in put full name... */,
          );
        ...
        children: [
          Container(
            ...
            child: InkWell(
              ...
              onTap: () async {
                logFirebaseEvent('COMPONENT_PHONE_COMP_bg_color_ON_TAP');
                            ...
                            FlutterFlowDropDown<String>(
                              controller: _model.dropDownValueController1 ??=
                                ...
                                _model.dropDownValue1 ??=
                                    FFLocalizations.of(context).getText(
                                  't1d6thbi' /* sovathvong@gmail.com */,
                                ),
                              ),
                              options: [
                                FFLocalizations.of(context).getText(
                                  'l3mgm5vl' /* sovathvong@gmail.com */,
                                ),
                                FFLocalizations.of(context).getText(
                                  '0lg4p7xv' /* sovathvong@oone.bz */,
                                )
                              ],
