...
import 'dart:ui';
import 'component_signature_detail_widget.dart'
    show ComponentSignatureDetailWidget;
...
class ComponentSignatureDetailModel
    extends FlutterFlowModel<ComponentSignatureDetailWidget> {
  ///  Local state fields for this component.

  Color? bg = Color(4285489647);

  Color penColor = Color(4279571998);
