...
import 'component_signature_detail_model.dart';
export 'component_signature_detail_model.dart';

class ComponentSignatureDetailWidget extends StatefulWidget {
  const ComponentSignatureDetailWidget({
    super.key,
    this.iconOne,
    this.iconTwo,
    this.iconThree,
  ...
  @override
  State<ComponentSignatureDetailWidget> createState() =>
      _ComponentSignatureDetailWidgetState();
}

class _ComponentSignatureDetailWidgetState
    extends State<ComponentSignatureDetailWidget>
    with TickerProviderStateMixin {
  late ComponentSignatureDetailModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ComponentSignatureDetailModel());
                                  ...
                                  child: Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          FFLocalizations.of(context).getText(
                                            'ehlcezve' /* Drag and drop files here or cl... */,
                                          ),
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              InkWell(
                                ...
                                onTap: () async {
                                  logFirebaseEvent(
                                      'COMPONENT_SIGNATURE_DETAIL_Text_lskyi28n');
                                  safeSetState(() {
                              ...
                              child: Row(
                                ...
                                children: [
                                  FlutterFlowIconButton(
                                    ...
                                    onPressed: () async {
                                      logFirebaseEvent(
                                          'COMPONENT_SIGNATURE_DETAIL_IconButtonBla');
                                      _model.penColor = Color(0xFF15161E);
                                      safeSetState(() {});
                                    },
                                  ),
                                  FlutterFlowIconButton(
                                    ...
                                    onPressed: () async {
                                      logFirebaseEvent(
                                          'COMPONENT_SIGNATURE_DETAIL_IconButtonBlu');
                                      _model.penColor = Color(0xFF0000FF);
                                      safeSetState(() {});
                                    },
                                  ),
                                  FlutterFlowIconButton(
                                    ...
                                    onPressed: () async {
                                      logFirebaseEvent(
                                          'COMPONENT_SIGNATURE_DETAIL_IconButtonRed');
                                      _model.penColor = Color(0xFFFF0000);
                                      safeSetState(() {});
                                    },
                                  ),
