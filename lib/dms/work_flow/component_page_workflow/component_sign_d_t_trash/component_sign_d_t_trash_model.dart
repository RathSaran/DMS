...
import 'dart:ui';
import 'component_sign_d_t_trash_widget.dart' show ComponentSignDTTrashWidget;
...
class ComponentSignDTTrashModel
    extends FlutterFlowModel<ComponentSignDTTrashWidget> {
  ///  State fields for stateful widgets in this component.

  // Stores action output result for [Backend Call - Query Rows] action in ComponentSign_DTTrash widget.
  List<FolderRow>? queryTrashFile;
