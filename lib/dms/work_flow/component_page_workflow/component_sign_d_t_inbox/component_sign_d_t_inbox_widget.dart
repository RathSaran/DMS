...
import 'component_sign_d_t_inbox_model.dart';
export 'component_sign_d_t_inbox_model.dart';

class ComponentSignDTInboxWidget extends StatefulWidget {
  const ComponentSignDTInboxWidget({
    super.key,
    int? currentTabbar,
  ...
  @override
  State<ComponentSignDTInboxWidget> createState() =>
      _ComponentSignDTInboxWidgetState();
}

class _ComponentSignDTInboxWidgetState
    extends State<ComponentSignDTInboxWidget> {
  late ComponentSignDTInboxModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ComponentSignDTInboxModel());

    // On component load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('COMPONENT_SIGN_D_T_INBOX_ComponentSign_D');
                ...
                label: DefaultTextStyle.merge(
                  ...
                  child: Builder(
                    builder: (context) => FlutterFlowIconButton(
                      ...
                      onPressed: () async {
                        logFirebaseEvent(
                            'COMPONENT_SIGN_D_T_INBOX_more_vert_outli');
                  ...
                  child: Align(
                    ...
                    child: Builder(
                      builder: (context) => InkWell(
                        ...
                        onTap: () async {
                          logFirebaseEvent(
                              'COMPONENT_SIGN_D_T_INBOX_Icon_fswwukgg_O');
                          await showAlignedDialog(
                            barrierColor: Colors.transparent,
                            context: context,
                            isGlobal: false,
                  ...
                  child: Row(
                    ...
                    children: [
                      if (messageDataItem.isRead ?? true)
                        Builder(
                          builder: (context) => FlutterFlowIconButton(
                            ...
                            onPressed: () async {
                              logFirebaseEvent(
                                  'COMPONENT_SIGN_D_T_INBOX_timeline_outlin');
                              await showDialog(
                                barrierColor: Colors.transparent,
                                context: context,
                                builder: (dialogContext) {
                                  return Dialog(
                                    ...
                                    child: Container(
                                      ...
                                      child: ComponentAcivityDocumentsWidget(
                                        name: messageDataItem.msgDescriptios!,
                                        documentId: messageDataItem.id,
                                      ),
                                    ),
                                  );
                      ...
                      FlutterFlowIconButton(
                        ...
                        onPressed: () async {
                          logFirebaseEvent(
                              'COMPONENT_SIGN_D_T_INBOX_remove_red_eye_');
