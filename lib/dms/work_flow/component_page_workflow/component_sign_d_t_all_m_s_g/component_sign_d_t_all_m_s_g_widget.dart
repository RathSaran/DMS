...
import 'component_sign_d_t_all_m_s_g_model.dart';
export 'component_sign_d_t_all_m_s_g_model.dart';

class ComponentSignDTAllMSGWidget extends StatefulWidget {
  const ComponentSignDTAllMSGWidget({
    super.key,
    int? currentTabbar,
  ...
  @override
  State<ComponentSignDTAllMSGWidget> createState() =>
      _ComponentSignDTAllMSGWidgetState();
}

class _ComponentSignDTAllMSGWidgetState
    extends State<ComponentSignDTAllMSGWidget> {
  late ComponentSignDTAllMSGModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ComponentSignDTAllMSGModel());

    // On component load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('COMPONENT_SIGN_D_T_ALL_M_S_G_ComponentSi');
      _model.queryAllFile = await FolderTable().queryRows(
        queryFn: (q) => q
            .eqOrNull(
              'type',
              'file',
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Builder(
        builder: (context) {
          final messageData = _model.queryAllFile?.toList() ?? [];
                ...
                label: DefaultTextStyle.merge(
                  ...
                  child: Builder(
                    builder: (context) => FlutterFlowIconButton(
                      ...
                      onPressed: () async {
                        logFirebaseEvent(
                            'COMPONENT_SIGN_D_T_ALL_M_S_G_more_vert_o');
                  ...
                  child: Align(
                    ...
                    child: Builder(
                      builder: (context) => InkWell(
                        ...
                        onTap: () async {
                          logFirebaseEvent(
                              'COMPONENT_SIGN_D_T_ALL_M_S_G_Icon_67j4bm');
                          await showAlignedDialog(
                            barrierColor: Colors.transparent,
                            context: context,
                            isGlobal: false,
                  ...
                  child: Row(
                    ...
                    children: [
                      if (messageDataItem.isRead ?? true)
                        Builder(
                          builder: (context) => FlutterFlowIconButton(
                            ...
                            onPressed: () async {
                              logFirebaseEvent(
                                  'COMPONENT_SIGN_D_T_ALL_M_S_G_timeline_ou');
                              await showDialog(
                                barrierColor: Colors.transparent,
                                context: context,
                                builder: (dialogContext) {
                      ...
                      FlutterFlowIconButton(
                        ...
                        onPressed: () async {
                          logFirebaseEvent(
                              'COMPONENT_SIGN_D_T_ALL_M_S_G_remove_red_');
