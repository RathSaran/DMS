...
import 'dart:ui';
import 'component_sign_d_t_priority_widget.dart'
    show ComponentSignDTPriorityWidget;
...
class ComponentSignDTPriorityModel
    extends FlutterFlowModel<ComponentSignDTPriorityWidget> {
  ///  State fields for stateful widgets in this component.

  // Stores action output result for [Backend Call - Query Rows] action in ComponentSign_DTPriority widget.
  List<FolderRow>? queryPriorityFile;
