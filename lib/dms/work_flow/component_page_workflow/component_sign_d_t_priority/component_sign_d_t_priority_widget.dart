...
import 'component_sign_d_t_priority_model.dart';
export 'component_sign_d_t_priority_model.dart';

class ComponentSignDTPriorityWidget extends StatefulWidget {
  const ComponentSignDTPriorityWidget({
    super.key,
    int? currentTabbar,
  ...
  @override
  State<ComponentSignDTPriorityWidget> createState() =>
      _ComponentSignDTPriorityWidgetState();
}

class _ComponentSignDTPriorityWidgetState
    extends State<ComponentSignDTPriorityWidget> {
  late ComponentSignDTPriorityModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ComponentSignDTPriorityModel());

    // On component load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('COMPONENT_SIGN_D_T_PRIORITY_ComponentSig');
      _model.queryPriorityFile = await FolderTable().queryRows(
        queryFn: (q) => q
            .eqOrNull(
              'type',
              'file',
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Builder(
        builder: (context) {
          final messageData = _model.queryPriorityFile?.toList() ?? [];
                ...
                label: DefaultTextStyle.merge(
                  ...
                  child: Builder(
                    builder: (context) => FlutterFlowIconButton(
                      ...
                      onPressed: () async {
                        logFirebaseEvent(
                            'COMPONENT_SIGN_D_T_PRIORITY_more_vert_ou');
                  ...
                  child: Align(
                    ...
                    child: Builder(
                      builder: (context) => InkWell(
                        ...
                        onTap: () async {
                          logFirebaseEvent(
                              'COMPONENT_SIGN_D_T_PRIORITY_Icon_wgxab8z');
                          await showAlignedDialog(
                            barrierColor: Colors.transparent,
                            context: context,
                            isGlobal: false,
                  ...
                  child: Row(
                    ...
                    children: [
                      if (messageDataItem.isRead ?? true)
                        Builder(
                          builder: (context) => FlutterFlowIconButton(
                            ...
                            onPressed: () async {
                              logFirebaseEvent(
                                  'COMPONENT_SIGN_D_T_PRIORITY_timeline_out');
                              await showDialog(
                                barrierColor: Colors.transparent,
                                context: context,
                                builder: (dialogContext) {
                      ...
                      FlutterFlowIconButton(
                        ...
                        onPressed: () async {
                          logFirebaseEvent(
                              'COMPONENT_SIGN_D_T_PRIORITY_remove_red_e');
