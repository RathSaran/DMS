...
import 'component_sign_d_t_draft_model.dart';
export 'component_sign_d_t_draft_model.dart';

class ComponentSignDTDraftWidget extends StatefulWidget {
  const ComponentSignDTDraftWidget({
    super.key,
    int? currentTabbar,
  ...
  @override
  State<ComponentSignDTDraftWidget> createState() =>
      _ComponentSignDTDraftWidgetState();
}

class _ComponentSignDTDraftWidgetState
    extends State<ComponentSignDTDraftWidget> {
  late ComponentSignDTDraftModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ComponentSignDTDraftModel());

    // On component load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('COMPONENT_SIGN_D_T_DRAFT_ComponentSign_D');
      _model.queryDraftFile = await FolderTable().queryRows(
        queryFn: (q) => q
            .eqOrNull(
              'type',
              'file',
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Builder(
        builder: (context) {
          final messageData = _model.queryDraftFile?.toList() ?? [];
                ...
                label: DefaultTextStyle.merge(
                  ...
                  child: Builder(
                    builder: (context) => FlutterFlowIconButton(
                      ...
                      onPressed: () async {
                        logFirebaseEvent(
                            'COMPONENT_SIGN_D_T_DRAFT_more_vert_outli');
                  ...
                  child: Align(
                    ...
                    child: Builder(
                      builder: (context) => InkWell(
                        ...
                        onTap: () async {
                          logFirebaseEvent(
                              'COMPONENT_SIGN_D_T_DRAFT_Icon_0pvzit6l_O');
                          await showAlignedDialog(
                            barrierColor: Colors.transparent,
                            context: context,
                            isGlobal: false,
                  ...
                  child: Row(
                    ...
                    children: [
                      if (messageDataItem.isRead ?? true)
                        Builder(
                          builder: (context) => FlutterFlowIconButton(
                            ...
                            onPressed: () async {
                              logFirebaseEvent(
                                  'COMPONENT_SIGN_D_T_DRAFT_timeline_outlin');
                              await showDialog(
                                barrierColor: Colors.transparent,
                                context: context,
                                builder: (dialogContext) {
                      ...
                      FlutterFlowIconButton(
                        ...
                        onPressed: () async {
                          logFirebaseEvent(
                              'COMPONENT_SIGN_D_T_DRAFT_remove_red_eye_');
