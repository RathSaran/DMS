...
import 'dart:ui';
import 'component_sign_d_t_draft_widget.dart' show ComponentSignDTDraftWidget;
...
class ComponentSignDTDraftModel
    extends FlutterFlowModel<ComponentSignDTDraftWidget> {
  ///  State fields for stateful widgets in this component.

  // Stores action output result for [Backend Call - Query Rows] action in ComponentSign_DTDraft widget.
  List<FolderRow>? queryDraftFile;
