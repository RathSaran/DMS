  ...
  try {
    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          case SeverityRow:
            return SeverityRow(data);
          case WorkflowSummaryRow:
            return WorkflowSummaryRow(data);
          case OrganizationRow:
            return OrganizationRow(data);
          case NotificationRow:
            return NotificationRow(data);
          case UserInfoRow:
            return UserInfoRow(data);
          case SubfolderRow:
            return SubfolderRow(data);
          case ConfigurationdocRow:
            return ConfigurationdocRow(data);
          case DocumentActivityRow:
            return DocumentActivityRow(data);
          case SeverityInfoRow:
            return SeverityInfoRow(data);
          case DepartmentsRow:
            return DepartmentsRow(data);
          case FilesRow:
            return FilesRow(data);
          case NotificationPermissionsRow:
            return NotificationPermissionsRow(data);
          case DepartmentInfoRow:
            return DepartmentInfoRow(data);
          case DocumentsRow:
            return DocumentsRow(data);
          case FolderRow:
            return FolderRow(data);
          case UsersRow:
            return UsersRow(data);
          case DocumentsUploadedRow:
            return DocumentsUploadedRow(data);
