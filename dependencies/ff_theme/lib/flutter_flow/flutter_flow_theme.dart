...
abstract class FlutterFlowTheme {
  ...
  late Color overlay;
  late Color overlay0;
  late Color draftStatus;
  late Color inProgressStatus;
  late Color scheduledStatus;
  late Color completedStatus;
  late Color rejectStatus;
  late Color expiredStatus;
  late Color secondaryButton;
  late Color primaryButton;
  late Color dangerButton;
  late Color removeStatus;
  late Color approvedStatus;
  late Color lowPriority;
  late Color mediumPriority;
  late Color highPriority;
  late Color urgentPriority;
...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color draftStatus = Color(0xFFF4F3FE);
  late Color inProgressStatus = Color(0xFFF9E79F);
  late Color scheduledStatus = Color(0xFFEDBB99);
  late Color completedStatus = Color(0xFFABEBC6);
  late Color rejectStatus = Color(0xFFAED6F1);
  late Color expiredStatus = Color(0xFFF5B7B1);
  late Color secondaryButton = Color(0xFF297AF3);
  late Color primaryButton = Color(0xFFF1F4F8);
  late Color dangerButton = Color(0xFFFF5963);
  late Color removeStatus = Color(0xFFFF5963);
  late Color approvedStatus = Color(0xFF297AF3);
  late Color lowPriority = Color(0xFF87FE7B);
  late Color mediumPriority = Color(0xFFF5FE86);
  late Color highPriority = Color(0xFFFC7F7D);
  late Color urgentPriority = Color(0xFFFA53AE);
}
